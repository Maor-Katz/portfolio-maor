...
class ClothesList extends React.Component {
    ...
    render() {
        ...
        const {filteredList, modalOpen, openOrCloseModalSize, isMobile, isBasketTime} = this.props;
        ...
        return (
            <div className="clothes">
                ...
                <Modal
                    isOpen={modalOpen}
                    ariaHideApp={false}
                    style={!isMobile ? this.custumModalSizeSelect : this.customStylesMobile}
                >
